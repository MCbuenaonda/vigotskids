            ...
            <div class="card-body p-5">
                <form action="{{ route('grupos.store') }}" method="POST" novalidate>
                    ...
                    <fieldset class="border p-4">
                        <legend class="text-primary">Crear un nuevo grupo</legend>

                        <div class="form-group">
                            <label for="nombre">Nombre de grupo</label>
                            <input type="text" onkeyup="this.value = this.value.toUpperCase();" id="nombre" name="nombre" class="form-control @error('nombre') is-invalid @enderror" value="{{ old('nombre') }}">
                            @error('nombre')
