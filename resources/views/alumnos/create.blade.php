                ...
                <form action="{{ route('alumnos.store') }}" method="POST" novalidate>
                    ...
                    <fieldset class="border p-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="ap_paterno" name="ap_paterno" class="form-control @error('ap_paterno') is-invalid @enderror" value="{{ old('ap_paterno') }}">
                            @error('ap_paterno')
                                <div class="invalid-feedback animate__animated animate__flash">{{$message}}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="ap_materno" name="ap_materno" class="form-control @error('ap_materno') is-invalid @enderror" value="{{ old('ap_materno') }}">
                            @error('ap_materno')
                                <div class="invalid-feedback animate__animated animate__flash">{{$message}}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="clave" name="clave" class="form-control @error('clave') is-invalid @enderror" value="{{ old('clave') }}">
                            @error('clave')
                                <div class="invalid-feedback animate__animated animate__flash">{{$message}}</div>
                            @enderror
                        </div>
